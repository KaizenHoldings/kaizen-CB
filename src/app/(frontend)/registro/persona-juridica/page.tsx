...
export const metadata: Metadata = {
  title: 'Formulario de Identificación de Clientes PJ -Kaizen Casa de Bolsa',
  description: 'Formulario de identificación de clientes persona jurídica de Kaizen Casa de Bolsa.',
  ...
  return (
    <div className="mx-auto min-h-[100dvh] w-full max-w-5xl px-4 pt-24 pb-12">
      ...
      <h1 className="font-[family-name:var(--font-display)] text-[clamp(1.5rem,1.25rem+1.2vw,2.125rem)] leading-[1.15] font-light text-balance text-navy">
        Formulario de Identificación de Clientes PJ -Kaizen Casa de Bolsa
      </h1>

      <div className="mt-10">
        <JotformEmbed formId="262094147868670" title="Formulario de Identificación de Clientes PJ -Kaizen Casa de Bolsa" />
      </div>
    </div>
  )
}
